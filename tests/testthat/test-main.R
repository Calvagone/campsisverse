...
test_that("Method 'process_version' works as expected", {
  ...
  expect_error(process_version("24-10-31"), regexp="Version 24-10-31 is not available. Available versions are: 24-12-01")
  expect_error(process_version("24.10.31"), regexp="Version 24\\.10\\.31 is not available. Available versions are: 24-12-01")
})

test_that("Method 'get_campsis_suite_packages' works as expected", {
  
  expect_equal(get_campsis_suite_packages(), c("campsismod", "campsis", "campsisnca", "campsismisc", "campsistrans", "campsisqual", "mrgsolve", "rxode2"))
  expect_equal(get_campsis_suite_packages(include_engines=FALSE), c("campsismod", "campsis", "campsisnca", "campsismisc", "campsistrans", "campsisqual"))
})
